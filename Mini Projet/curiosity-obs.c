...
void gestion_erreur_terrain(erreur_terrain e)
{
    ...
    case ERREUR_DIMENSION :
        printf("Erreur lecture du terrain : dimensions incorrectes\n");
        exit(1);
    case ERREUR_FORMAT:
        printf("Erreur lecture du terrain : le format n'est pas le bon\n");
        exit(1);
    case ERREUR_ROBOT_ABSENT:
        printf("Erreur lecture du terrain : le robot est absent\n");
        exit(1);
    }
}
...
int main(int argc, char **argv)
{
    ...
    case ERREUR_PILE_VIDE:
        eprintf("ERREUR : pile vide\n");
        break;
    case ERREUR_ADRESSAGE:
        eprintf("ERREUR : erreur d'adressage\n");
        break;
    case ERREUR_DIVISION_PAR_ZERO:
        eprintf("ERREUR : division par 0\n");
        break;

    default:
        eprintf("Les proprités sont validés pour ce programme.");
    }
}
